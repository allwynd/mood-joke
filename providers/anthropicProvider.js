 ...
 *
 * Also records token usage and rate-limit headers via usageTracker on every
 * call — this lives here (not in the agent) because .withResponse() and the
 * usage/header shape are Anthropic-specific.
 *
